...
export const STR = {
  ...
  "notif.milestone": { fr: "Bravo : {lang} a franchi le cap de {count} contributions 🎉", en: "Well done: {lang} has reached {count} contributions 🎉" },
  ...
  "notif.request": { fr: "{who} cherche la traduction de « {mot} » dans {lang}. Tu peux l'aider ?", en: "{who} is looking for the translation of “{mot}” in {lang}. Can you help?" },
  "notif.request_share": { fr: "Quelqu'un cherche la traduction de « {mot} » dans {lang}. Tu connais une personne qui parle cette langue ? Partage la demande.", en: "Someone is looking for the translation of “{mot}” in {lang}. Do you know someone who speaks it? Share the request." },
  ...
  "req.f.texte": { fr: "Mot ou phrase", en: "Word or phrase" },
  "req.f.texte.ph": { fr: "ex. mangue", en: "e.g. mango" },
  "req.f.langue": { fr: "Langue demandée", en: "Requested language" },
  "req.f.kind": { fr: "Ce que tu demandes", en: "What you ask for" },
  ...
  "req.err.fields": { fr: "Indique le mot ou la phrase et la langue demandée.", en: "Enter the word or phrase and the requested language." },
