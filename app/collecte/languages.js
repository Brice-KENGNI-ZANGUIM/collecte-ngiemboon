...
export const SEED_LANGUAGES = [
  ...
  { id: "swa", nom: "Swahili", autonyme: "Kiswahili",
    region: "Afrique de l'Est (Tanzanie, Kenya, RDC, Ouganda…)", clavier: "defaut",
  ...
  { id: "bas", nom: "Bassa", autonyme: "Ɓàsàa",
    region: "Cameroun (Sanaga-Maritime, Centre / Littoral)", clavier: "defaut",
